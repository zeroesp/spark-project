...
public class ProducerEvent {
  // compile : /usr/jdk64/jdk1.8.0_112/bin/javac -cp .:kafka-clients-1.0.0.jar:slf4j-api-1.7.25.jar ProducerEvent.java
  // execute : /usr/jdk64/jdk1.8.0_112/bin/java -cp .:kafka-clients-1.0.0.jar:slf4j-api-1.7.25.jar ProducerEvent 10000
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      for (int i = 0; i < num; i++) {
        String msg = "{\"message\":" + i + ",\"hosts\":\"" + hosts[(int)Math.floor(Math.random()*4.9)] + "\"}";
        kafkaProcuder.send(new ProducerRecord<String, String>("event_test", msg));
